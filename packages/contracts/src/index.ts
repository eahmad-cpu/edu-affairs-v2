...
export const TransportRouteSchema = AuditFieldsSchema.merge(
  z.object({
    id: NonEmptyStringSchema,
    orgId: NonEmptyStringSchema,
    schoolId: NonEmptyStringSchema,
    title: NonEmptyStringSchema,
    busSupervisorPersonId: z.string().optional().default(""),
    isActive: z.boolean().default(true),
  }),
);
...
/**
 * اشتراك الطالب في النقل المدرسي
 * مهم لأنه يفصل بين:
 * - الطالب الذي يستخدم الباص
 * - الطالب الذي يحضره ولي أمره
 */
...
export type StudentTransportDirection = z.infer<
  typeof StudentTransportDirection
>;

export const StudentTransportEnrollmentStatus = z.enum([
  "ACTIVE",
  "PAUSED",
  "ENDED",
]);
export type StudentTransportEnrollmentStatus = z.infer<
  typeof StudentTransportEnrollmentStatus
>;

export const StudentTransportEnrollmentSchema = AuditFieldsSchema.merge(
  z.object({
    id: NonEmptyStringSchema,
    orgId: NonEmptyStringSchema,
    schoolId: NonEmptyStringSchema,
...
export type TransportAttendanceStatus = z.infer<
  typeof TransportAttendanceStatus
>;
...
export type TransportTripDirection = z.infer<typeof TransportTripDirection>;

export const StudentTransportAttendanceRecordSchema = AuditFieldsSchema.merge(
  z.object({
    id: NonEmptyStringSchema,
    orgId: NonEmptyStringSchema,
    schoolId: NonEmptyStringSchema,
    ...
    studentId: NonEmptyStringSchema,
    enrollmentId: z.string().optional().default(""),
    transportEnrollmentId: NonEmptyStringSchema,
    routeId: NonEmptyStringSchema,
    ...
    /**
     * ربط سجل حضور النقل الفردي بدفعة حضور نقل جماعية
     */
    batchId: z.string().optional().default(""),
...
/**
 * Transport Attendance Batches
 * دفعات حضور النقل المدرسي
 */

export const TransportAttendanceBatchStatus = z.enum([
  "DRAFT",
  "IN_PROGRESS",
  "SUBMITTED",
  "REVIEWED",
...
export type TransportAttendanceBatchStatus = z.infer<
  typeof TransportAttendanceBatchStatus
>;

export const TransportAttendanceBatchStudentRowStatus = z.enum([
  "PENDING",
  "COMPLETED",
  "EXCUSED",
  "SKIPPED",
]);
export type TransportAttendanceBatchStudentRowStatus = z.infer<
  typeof TransportAttendanceBatchStudentRowStatus
>;

export const TransportAttendanceBatchRecordRefStatus = z.enum([
  "PENDING",
  "COMPLETED",
  "MISSING",
  "CANCELLED",
]);
export type TransportAttendanceBatchRecordRefStatus = z.infer<
  typeof TransportAttendanceBatchRecordRefStatus
>;

export const TransportAttendanceBatchRecordRefSchema = z.object({
  studentId: NonEmptyStringSchema,
  transportEnrollmentId: z.string().optional().default(""),
  recordId: z.string().optional().default(""),
  status: TransportAttendanceBatchRecordRefStatus.default("PENDING"),
});
export type TransportAttendanceBatchRecordRef = z.infer<
  typeof TransportAttendanceBatchRecordRefSchema
>;
...
export const TransportAttendanceBatchStudentRowSchema = z.object({
  ...
  status: TransportAttendanceStatus,
  rowStatus: TransportAttendanceBatchStudentRowStatus.default("PENDING"),
...
export const TransportAttendanceBatchSchema = AuditFieldsSchema.merge(
  z.object({
    id: NonEmptyStringSchema,
    orgId: NonEmptyStringSchema,
    schoolId: NonEmptyStringSchema,
    ...
    scopeType: OperationScopeType.default("ROUTE"),
    scopeId: z.string().optional().default(""),

    status: TransportAttendanceBatchStatus.default("DRAFT"),
    ...
    studentRows: z.array(TransportAttendanceBatchStudentRowSchema).default([]),
    recordRefs: z.array(TransportAttendanceBatchRecordRefSchema).default([]),
...
/**
 * Student cases / referrals / routing
 * القضايا الطلابية + الإحالات + سجل التحويلات
 */
...
export const StudentCaseTypeSchema = AuditFieldsSchema.merge(
  z.object({
    id: NonEmptyStringSchema,
    title: NonEmptyStringSchema,
    schoolType: SchoolType,

    defaultOwnerRoleKey: MembershipRole,
    allowedForwardToRoleKeys: z.array(MembershipRole).default([]),
...
export const StudentCaseSchema = AuditFieldsSchema.merge(
  z.object({
    id: NonEmptyStringSchema,
    orgId: NonEmptyStringSchema,
    schoolId: NonEmptyStringSchema,
    ...
    caseTypeId: NonEmptyStringSchema,
    title: NonEmptyStringSchema,
    description: z.string().optional().default(""),
    ...
    currentAssignedPersonId: z.string().optional().default(""),

    /**
     * من أنشأ القضية أول مرة
     */
    createdByPersonId: NonEmptyStringSchema,
    createdByRoleKey: MembershipRole.optional(),
    ...
    /**
     * آخر ملخص سريع يظهر في القوائم
     */
    latestNote: z.string().optional().default(""),
    ...
    resolvedByPersonId: z.string().optional().default(""),
...
export const StudentCaseRoutingEventSchema = AuditFieldsSchema.merge(
  z.object({
    id: NonEmptyStringSchema,
    ...
    fromOwnerRoleKey: MembershipRole.optional(),
    fromAssignedPersonId: z.string().optional().default(""),

    toOwnerRoleKey: MembershipRole.optional(),
    toAssignedPersonId: z.string().optional().default(""),

    performedByPersonId: NonEmptyStringSchema,
    performedByRoleKey: MembershipRole.optional(),

    performedAt: TimestampMsSchema,
    note: z.string().optional().default(""),
  }),
);
export type StudentCaseRoutingEvent = z.infer<
  typeof StudentCaseRoutingEventSchema
>;

export const StudentCaseLogEntrySchema = AuditFieldsSchema.merge(
  z.object({
    id: NonEmptyStringSchema,
    caseId: NonEmptyStringSchema,
    orgId: NonEmptyStringSchema,
    ...
    /**
     * اختياري لو كان الإدخال مرتبطًا بملف أو مرفق
     */
    attachmentRefId: z.string().optional().default(""),
  }),
);
export type StudentCaseLogEntry = z.infer<typeof StudentCaseLogEntrySchema>;
